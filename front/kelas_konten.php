...
<div class="container py-5">
    <div class="row align-items-center">
        <div class="col-md-6 text-md-start text-start py-6">
            ...
            <div class="text-start text-md-start"><a class="btn btn-primary" href="#" role="button"
                    id="btn-course">Register</a></div>
        </div>
        ...
        <div class="col-4">
            <div class="card shadow">
                <div class="card-body p-4">
                    ...
                    <a href="#" class="btn btn-primary d-grid gap-2 col-6 mx-auto">Register Now!</a>
                </div>
            </div>
        </div>
    </div>
