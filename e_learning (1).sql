...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2022 at 06:41 PM
...
INSERT INTO `review` (`id_review`, `id_user`, `review`) VALUES
('1', 11, 'You prepare people to carry out skills in the real world. Keep up the good work. What I have learned in this course, I will be able to apply in the real world.'),
('2', 11, 'I received my certificate, and I would like to thank you for your support. Your course was challenging, but you were always there supporting me and ready to help. I enjoyed your class tremendously. I look forward to taking another class with you.'),
('3', 11, 'I liked that the course included step-by-step exercises and tutorials PLUS unassisted assignments. Unlike exercises where a student can get by simply doing as directed, the assignments reveal the real learning. The assignments were where I discovered whet');
